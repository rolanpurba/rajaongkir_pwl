...
@push('styles')
    <style>
        ...
        .form-group input,.form-group textarea{width:100%;border:1px solid #e2e8f0;border-radius:8px;padding:9px 12px;font-size:13.5px;color:#1e293b;outline:none;transition:border-color .15s;background:#fff}
        .form-group input:focus,.form-group textarea:focus{border-color:#0f2544;box-shadow:0 0 0 3px rgba(15,37,68,0.07)}
        ...
        .current-photo{display:flex;align-items:center;gap:12px;background:#f8fafc;border:1px solid #e8edf3;border-radius:8px;padding:10px 14px;margin-bottom:10px}
        .current-photo img{width:56px;height:56px;object-fit:cover;border-radius:7px;border:1px solid #e2e8f0}
        .current-photo p{font-size:12.5px;color:#64748b}
        .file-input-wrap{border:2px dashed #e2e8f0;border-radius:8px;padding:16px;text-align:center;cursor:pointer;transition:border-color .15s}
        .file-input-wrap:hover{border-color:#0f2544}
        .file-input-wrap input{display:none}
        .file-input-wrap i{font-size:24px;color:#94a3b8;display:block;margin-bottom:4px}
        ...
        .btn-primary{background:#0f2544;color:#fff;font-size:13.5px;font-weight:500;padding:9px 22px;border-radius:8px;border:none;cursor:pointer;display:inline-flex;align-items:center;gap:7px;transition:background .15s}
...
@section('content')
    ...
    <div class="form-card">
        <h2><i class="ti ti-edit" style="font-size:18px;vertical-align:-2px;margin-right:8px;color:#0f2544"></i>Edit Produk</h2>
        ...
        <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group" style="margin-bottom:0">
                    ...
                    <div class="form-hint">Untuk hitung ongkir</div>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top:18px">
                ...
                @if($product->photo)
                    <div class="current-photo">
                        <img src="{{ asset('storage/'.$product->photo) }}" alt="Foto saat ini">
                ...
                <div class="file-input-wrap" onclick="document.getElementById('photo').click()">
                    ...
                    <p id="file-label">Klik untuk upload foto baru</p>
                    <img id="preview" src="" style="display:none;max-height:100px;margin:8px auto 0;border-radius:6px">
                </div>
            </div>
